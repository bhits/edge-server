...
@Configuration
@ConditionalOnProperty(value = "c2s.edge-server.expose-trace-id-in-response", havingValue = "true")
public class ExposeTraceIdInResponseConfig {
    @Bean
    ...
    static class HttpResponseInjectingTraceFilter extends GenericFilterBean {
        ...
        @Override
        public void doFilter(ServletRequest request, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException, IOException, ServletException {
